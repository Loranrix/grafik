...
<body>
    <div class="container">
        ...
        <div class="action-buttons">
            <a href="confirm-punch.php?type=in" class="btn btn-in">Ierašanās</a>
            <a href="confirm-punch.php?type=out" class="btn btn-out">Aiziešana</a>
            <a href="consumption.php" class="btn btn-consumption">Patēriņš</a>
            <a href="message.php" class="btn btn-message">💬 Ziņojums</a>
